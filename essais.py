...
X = 0
Y = 0
Canevas = Canvas(fenetre,width=300,height=200,bg ='white')
# Création d'un objet graphique



rond = Image.open("main-car.png")
long,large=rond.size
facteur=0.15
long=int(long*facteur)
large=int(large*facteur)
rond = rond.resize((long, large), Image.ANTIALIAS)
rond = ImageTk.PhotoImage(rond)
voiture = Canevas.create_image(10,10,anchor=NW, image=rond)
